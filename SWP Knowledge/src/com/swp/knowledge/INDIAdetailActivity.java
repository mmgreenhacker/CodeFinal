...
public class INDIAdetailActivity extends Activity {
	public int iTyped = 0;
	public int iPos = 0;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iTyped = intent.getIntExtra(INDIAlistActivity.EXTRA_MESSAGE_INDIA_TYPE, 0);
		iPos = intent
				.getIntExtra(INDIAlistActivity.EXTRA_MESSAGE_INDIA_POSITION, 0);

		setContentView(R.layout.activity_indiadetail);
		...
		ImageView imageview = (ImageView)findViewById(R.id.imageINDIAdetail);
