...
public class CHINAdetailActivity extends Activity {
	public int iTyped = 0;
	public int iPos = 0;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iTyped = intent.getIntExtra(CHINAlistActivity.EXTRA_MESSAGE_CHINA_TYPE, 0);
		iPos = intent
				.getIntExtra(CHINAlistActivity.EXTRA_MESSAGE_CHINA_POSITION, 0);

		setContentView(R.layout.activity_chinadetail);
		...
		ImageView imageview = (ImageView)findViewById(R.id.imageCHINAdetail);
