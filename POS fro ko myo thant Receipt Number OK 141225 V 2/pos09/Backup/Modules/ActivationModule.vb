...
Module ActivationModule
    ...
    Public Function CreateKey(ByVal x As Long) As String
        Dim Key As Long = x * x + 45 / x + 323 * (x / 3)
    ...
    Public Function GenSerial() As String
        ...
        Try
            ...
            strPKey = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\BP\BPpos\ProductKey", "PKey", "Error!").ToString()
            If strPKey <> "" Then
    ...
    Public Function CreateReg(ByVal r As String) As Boolean
        ...
        Try
            newKey = My.Computer.Registry.CurrentUser.CreateSubKey("Software\BP\BPpos")
            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "key", r)
            Return True
        Catch ex As Exception
            MessageBox.Show(ex.ToString())
            Return False
    ...
    Public Function ReadReg() As String
        ...
        Try
            keyValue = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "key", "Error!")
            Return keyValue
        Catch ex As Exception
            MessageBox.Show(ex.ToString())
            Return "Error"
