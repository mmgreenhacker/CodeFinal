    ...
    Private Sub btnChallengeKey_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChallengeKey.Click
        ...
        If (strProductKey <> "") Then
            ...
            Try
                ...
                My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\BP\BPpos\ProductKey", "PKey", intPKey.ToString())
            ...
            If (strProductKey.Contains("11325")) Then
                strCPU1 = getCPU_ID()
    ...
    Private Sub btnActiveKey_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActiveKey.Click
        ...
        If txtActivateKey.Text <> "" Then
            ...
            Try
                Dim newKey As RegistryKey
                newKey = My.Computer.Registry.CurrentUser.CreateSubKey("Software\BP\BPpos")
                strPKey = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\BP\BPpos\ProductKey", "PKey", "Error!")
