...
Public Class frmChangeUname
    ...
    Private Sub btnChange_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChange.Click
        ...
        Try
            strUname = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "Uname", "Error!")
            strPass = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "Pass", "Error!")
        ...
        If strUname = "" Or strPass = "" Then
            Try
                newKey = My.Computer.Registry.CurrentUser.CreateSubKey("Software\BP\BPpos")
                My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "Uname", "admin")
                My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "Pass", "admin")
            Catch ex As Exception
                MessageBox.Show(ex.ToString())
            End Try
        ...
        If strOldUname = strUname And strOldPass = strPass Then
            Try
                newKey = My.Computer.Registry.CurrentUser.CreateSubKey("Software\BP\BPpos")
                My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "Uname", strNewUname)
                My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\BP\BPpos\Serial", "Pass", strNewPass)
                MessageBox.Show("User name and Password change successfully!", "Success!", MessageBoxButtons.OK, MessageBoxIcon.Information)
                LoginForm1.Label1.Text = ""
                Me.Close()
            Catch ex As Exception
                MessageBox.Show(ex.ToString())
            End Try
