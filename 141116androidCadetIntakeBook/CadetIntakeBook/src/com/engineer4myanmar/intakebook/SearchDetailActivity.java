...
public class SearchDetailActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String sCadetName = myIntent.getStringExtra(SearchActivity.EXTRA_MESSAGE_SEARCHDETAIL);
    ...
    {
    	startActivity(new Intent(SearchDetailActivity.this,CadetIBookMainActivity.class));   
